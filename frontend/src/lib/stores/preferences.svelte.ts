...
function isValidColor(value: unknown): value is AccentColor {
  return (
    typeof value === "string" && VALID_COLORS.includes(value as AccentColor)
  );
}
...
function isValidItemsPerPage(value: unknown): value is ItemsPerPage {
  return (
    typeof value === "number" &&
    VALID_ITEMS_PER_PAGE.includes(value as ItemsPerPage)
  );
}
...
function validatePreferences(
  ...
  return {
    ...
    dateFormat: ["relative", "absolute", "iso"].includes(
