...
from backend.automation.engine.batches import expand_batch
from backend.automation.engine.batches import update_batch_status
from backend.automation.engine.params import resolve_params
from backend.automation.engine.runner import execute_run
from backend.automation.engine.scheduler import due_schedules
from backend.automation.engine.scheduler import tick
from backend.automation.models import BatchItem
from backend.automation.models import PipelineRun
from backend.automation.models import RunStatus
from backend.automation.tests.factories import BatchFactory
from backend.automation.tests.factories import PipelineFactory
from backend.automation.tests.factories import PipelineRunFactory
from backend.automation.tests.factories import PipelineStepFactory
from backend.automation.tests.factories import PipelineStepRunFactory
from backend.automation.tests.factories import ScheduleFactory
...
class TestLinearPipelineSuccess:
    ...
    def test_notify_step_succeeds(self):
        ...
        with patch("backend.automation.engine.dispatchers.publish"):
            execute_run(run.id)
...
class TestFailurePropagation:
    ...
    def test_generate_dispatcher_failure_propagates(self):
        ...
        with patch(
            "backend.automation.engine.dispatchers.dispatch_generate",
...
class TestRetries:
    def test_step_succeeds_on_second_attempt(self):
        ...
        original_wait = __import__(
            "backend.automation.engine.dispatchers",
        ...
        with patch(
            "backend.automation.engine.dispatchers.dispatch_wait",
...
class TestScheduler:
    ...
    def test_tick_triggers_due_schedule(self):
        ...
        with (
            patch("backend.automation.engine.runner.execute_run"),
            patch("backend.automation.services._celery_available", return_value=False),
        ):
            fired = tick(now=now)
...
class TestDispatcherMocking:
    ...
    def test_analyze_dispatcher_called(self):
        ...
        with patch(
            "backend.automation.engine.dispatchers.dispatch_analyze",
    ...
    def test_report_dispatcher_called(self):
        ...
        with patch(
            "backend.automation.engine.dispatchers.dispatch_report",
