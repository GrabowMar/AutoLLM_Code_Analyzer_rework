...
from backend.generation.services.aider_runner import AiderIterationResult
...
class TestRunCopilotWithAider:
    @patch("backend.generation.services.copilot_results.CopilotResults.apply")
    @patch("backend.generation.services.aider_runner.AiderRunner")
    @patch("backend.generation.services.copilot_workspace.CopilotWorkspace.create")
    ...
    @patch(
        "backend.generation.services.aider_runner.AiderRunner._run_aider_message",
        return_value="ok",
    )
    @patch(
        "backend.generation.services.aider_runner.AiderRunner._ensure_aider_available",
    )
    @patch(
        "backend.generation.services.aider_runner.resolve_copilot_api_key",
