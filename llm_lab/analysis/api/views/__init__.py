...
from llm_lab.analysis.api.views import tools  # noqa: F401  (register routes)
from llm_lab.analysis.api.views import workspace  # noqa: F401  (register routes)
from llm_lab.analysis.api.views import installed  # noqa: F401  (register routes)
from llm_lab.analysis.api.views import runs  # noqa: F401  (register routes)
